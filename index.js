...
mongoose
  ...
  //  `mongodb+srv://${process.env.MONGO_DB_USER}:${process.env.MONGO_DB_PASSWORD}@cluster0.u4bvv.mongodb.net/${process.env.MONGODB_DATABASE}?retryWrites=true&w=majority`,
    ...
    `mongodb+srv://${process.env.MONGO_DB_USER}:${process.env.MONGO_DB_PASSWORD}@cluster0.egoqemt.mongodb.net/${process.env.MONGO_DB_database}?retryWrites=true&w=majority`,
